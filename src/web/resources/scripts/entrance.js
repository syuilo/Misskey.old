...
function initRegisterForm() {
	...
	function initPasswordSection() {
		...
		$nextButton.click(function() {
			...
			$('#registerForm .user-name').css('transform', 'perspective(512px) translateX(-900px) translateZ(0) rotateY(0)');

			$('#registerForm .nickname').css('transform', 'perspective(512px) translateX(-600px) translateZ(0) rotateY(0)');
	...
	function initPasswordRetypeSection() {
		...
		$backButton.click(function() {
			...
			$('#registerForm .nickname').css('transform', 'perspective(512px) translateX(-300px) translateZ(0) rotateY(-45deg)');

			$('#registerForm .user-name').css('transform', 'perspective(512px) translateX(-600px) translateZ(0) rotateY(-45deg)');
		...
		$nextButton.click(function() {
			...
			$('#registerForm .user-name').css('transform', 'perspective(512px) translateX(-1200px) translateZ(-100px) rotateY(-45deg)');

			$('#registerForm .nickname').css('transform', 'perspective(512px) translateX(-900px) translateZ(-100px) rotateY(-45deg)');
