require! {
	...
	'../../web/main/sites/desktop/utils/serialize-talk-message'
					...
					try
						...
						if content.type? && content.value?
							...
							| \me-message, \otherparty-message =>
								...
								# Send message HTML
								message-compiler = jade.compile-file "#__dirname/../../web/main/sites/desktop/views/dynamic-parts/user-talk/message.jade"
